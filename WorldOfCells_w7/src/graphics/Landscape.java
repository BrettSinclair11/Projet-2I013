...
public class Landscape implements GLEventListener, KeyListener, MouseListener{
		 ...
		 * 
		 * Bonnes pratiques:
		 * - gl.Begin() ... gl.glEnd(); : faire un minimum d'appel, idealement un par iteration. (gain de 50% e 100% ici)
		...
		private float rotationVelocity = 0.f; // 0.2f
		
		private float Xrotated = 0.f;
        ...
        public void display(GLAutoDrawable gLDrawable) {
                ...
                else
                {
                    ...
                    Xrotated = (Xrotated + rotateX) % 360.f;
                    gl.glRotatef(-90.f, 1.0f, 0.0f, 0.0f);
                }
        ...
        */
		...
		public void keyPressed(KeyEvent key) {
			...
			case KeyEvent.VK_DOWN:
				movingY = ( movingY - 1 + dxView-1 ) % (dyView-1);
				break;
