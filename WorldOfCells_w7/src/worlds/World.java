...
public abstract class World {
    ...
    abstract public int getCellValue1(int x, int y);
    abstract public int getCellValue2(int x, int y);
    abstract public int getCellValue3(int x, int y);
    abstract public int getCellValue4(int x, int y);
    abstract public int getCellValue5(int x, int y);
    abstract public int getCellValue6(int x, int y);
    abstract public void setCellValue(int x, int y, int state);
    abstract public void setCellValue1(int x, int y, int state);
    abstract public void setCellValue2(int x, int y, int state);
    abstract public void setCellValue3(int x, int y, int state);
    abstract public void setCellValue4(int x, int y, int state);
    abstract public void setCellValue5(int x, int y, int state);
    abstract public void setCellValue6(int x, int y, int state);
